...
export NBASE=$(word 1,$(subst ., ,$(NINJAMIN)))
export NMAJOR=$(word 2,$(subst ., ,$(NINJAMIN)))
export NMINOR=$(word 3,$(subst ., ,$(NINJAMIN)))
...
$(SCRIPTVERSION): $(META)
	...
	@ECHO const int G1CP_NinjaMinVer = $(NBASE)*1000+$(NMAJOR)*100+$(NMINOR);>>   "$(call FixPath,$@)"
	@ECHO const string G1CP_NinjaMinVerStr = ^"$(NINJAMIN)^";>>                   "$(call FixPath,$@)"

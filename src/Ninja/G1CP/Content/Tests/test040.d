...
func int G1CP_Test_040() {
    ...
    var int funcId; funcId = MEM_GetSymbolIndex("VLK_585_Aleph_DIRTY_Condition");
    if (funcId == -1) {
    ...
    // Backup values
    var int told1Bak; told1Bak = Npc_KnowsInfo(hero, MEM_GetSymbolIndex("GRD_271_ULBERT_DRUNK"));   // Told status
    var int told2Bak; told2Bak = Npc_KnowsInfo(hero, MEM_GetSymbolIndex("GRD_261_Brandick_ALEPH")); // Told status
    var int told3Bak; told3Bak = Npc_KnowsInfo(hero, MEM_GetSymbolIndex("VLK_585_Aleph_SCHUPPEN")); // Told status

...
func void G1CP_Test_194() {
    ...
    Wld_InsertNpc(G1CP_Test_194_Npc, wp);
    var C_Npc test; test = Hlp_GetNpc(G1CP_Test_194_Npc);
 ...
 */
instance G1CP_Test_194_Npc(C_Npc) {
    name          = "Test 194";
    attribute[0]  = 2;
    attribute[1]  = 2;
    start_aistate = ZS_G1CP_Test_194_NpcRountine;
    senses        = 7;
    senses_range  = 2000;
 ...
 */
func void ZS_G1CP_Test_194_NpcRountine() {};
func int  ZS_G1CP_Test_194_NpcRountine_Loop() {
    // Help out to abort here
    if (Npc_HasItems(self, MEM_GetSymbolIndex("Whistlers_Schwert"))) {
        Npc_ClearAiQueue(hero);
        AI_Function(hero, G1CP_Test_194_Success);
        return 1;
    };
...
func void G1CP_Test_194_Success() {
    ...
    AI_Function_I(hero, Wld_RemoveNpc, G1CP_Test_194_Npc);
};

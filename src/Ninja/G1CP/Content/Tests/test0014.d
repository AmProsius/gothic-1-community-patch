...
func void G1CP_Test_0014() {
    const string instr[6] = {
        ...
        "First draw a weapon to provoke an NPC into a fight (do not damage them!). Enter and leave the nearby room.",
        "The NPC will continue the fight.",
        "In a second run, enter a room and wait for an NPC to react and to attack the PC.",

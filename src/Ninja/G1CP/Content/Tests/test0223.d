 ...
 */
func int G1CP_Test_0223_CallFunc(var int funcId, var string topic, var string iter) {
...
func int G1CP_Test_0223() {
    ...
    passed += G1CP_Test_0223_CallFunc(funcId, CH1_GotoPsiCamp, "first");

    // Second pass
    G1CP_SetIntVarI(ncQuestId, 0, 0);
    G1CP_SetIntVarI(ocQuestId, 0, LOG_RUNNING);
    passed += G1CP_Test_0223_CallFunc(funcId, CH1_GotoPsiCamp, "second");

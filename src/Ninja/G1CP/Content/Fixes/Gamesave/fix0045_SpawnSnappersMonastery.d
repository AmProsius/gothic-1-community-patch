 ...
 */
instance G1CP_0045_SpawnSnappersMonastery_Snapper1 (C_Npc);
instance G1CP_0045_SpawnSnappersMonastery_Snapper2 (C_Npc);


/*
 * One-time checks
 */
func int G1CP_0045_SpawnSnappersMonastery_InitSession() {
 ...
 * Apply the changes
 */
func int G1CP_0045_SpawnSnappersMonastery() {
    // Do one-time checks
    const int fixNecessary = -1;
    if (fixNecessary == -1) {
        fixNecessary = G1CP_0045_SpawnSnappersMonastery_InitSession();
    };
    ...
    if (snapper1) && (snapper2) {
        ...
        G1CP_0045_SpawnSnappersMonastery_Snapper1 = _^(snapper1);
        G1CP_0045_SpawnSnappersMonastery_Snapper2 = _^(snapper2);
        return TRUE;
    } else {
        return FALSE;
    };
 ...
 */
func int G1CP_0045_SpawnSnappersMonasteryRemoveSpawn(var C_Npc slf) {
 ...
 * Revert the changes
 */
func int G1CP_0045_SpawnSnappersMonasteryRevert() {
    // Remove snappers from the spawn manager
    var int count; count = 0;
    count += G1CP_0045_SpawnSnappersMonasteryRemoveSpawn(G1CP_0045_SpawnSnappersMonastery_Snapper1);
    count += G1CP_0045_SpawnSnappersMonasteryRemoveSpawn(G1CP_0045_SpawnSnappersMonastery_Snapper2);

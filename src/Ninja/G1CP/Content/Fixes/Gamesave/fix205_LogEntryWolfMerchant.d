 ...
 */
func void G1CP_205_LogEntryWolfMerchant_Intercept(var string topic, var string entry) {
 ...
 */
func int G1CP_205_LogEntryWolfMerchant() {
    return G1CP_205_LogEntryWolfMerchant_Toggle(TRUE);
};

/*
 * This function reverts the changes
 */
func int G1CP_205_LogEntryWolfMerchantRevert() {
    // Only revert if it was applied by the G1CP
    if (!G1CP_IsFixApplied(205)) {
        return FALSE;
    };

    return G1CP_205_LogEntryWolfMerchant_Toggle(FALSE);
};

 ...
 */
func int G1CP_0055_ReactivateInExtremo_InitSession() {
    ...
    if (adjustStrtMs) {
        ...
        MEMINT_OFTokPar(zPAR_TOK_CALL, MEM_GetFuncOffset(G1CP_0055_ReactivateInExtremo_PlayTrue));
    };
    if (adjustStopMs) {
        MEMINT_OverrideFunc_Ptr = adjustStopMs;
        MEMINT_OFTokPar(zPAR_TOK_CALL, MEM_GetFuncOffset(G1CP_0055_ReactivateInExtremo_PlayFalse));
    };
    if (adjustDiaGrm) {
 ...
 */
func int G1CP_0055_ReactivateInExtremo_InitWorld() {
    ...
    HookDaedalusFuncS("B_Kapitelwechsel", "G1CP_0055_ReactivateInExtremoHook");
    HookDaedalusFuncS("IE_397_Announcer_ANNOUNCE_Info", "G1CP_0055_ReactivateInExtremo_StartMusicDialog");
 ...
 * Apply the changes
 */
func int G1CP_0055_ReactivateInExtremo() {
    // On first call, do some general checks
    const int sessionOkay = -1;
    if (sessionOkay == -1) {
        sessionOkay = G1CP_0055_ReactivateInExtremo_InitSession();
    };
    ...
    if (worldOkay == -1) {
        worldOkay = G1CP_0055_ReactivateInExtremo_InitWorld();
    };
 ...
 * Revert the changes
 */
func int G1CP_0055_ReactivateInExtremoRevert() {
 ...
 */
func void G1CP_0055_ReactivateInExtremo_StartMusicDialog() {
    G1CP_ReportFuncToSpy();

...
func int G1CP_0046_SmithDoor() {
    ...
    if (!G1CP_IsItemInstantiated("G1CP_0046_SmithDoor_Item")) {
        ...
        if (!MEM_ReadInt(varPtr)) { // It follows from above that varPtr is not zero
            ...
            if (funcId != -1) {
                ...
                if (funcHooked == 0) {
                    ...
                    if (funcGood == TRUE) {
                        HookDaedalusFuncI(funcId, MEM_GetFuncId(G1CP_0046_SmithDoor_HookStory));
                    };
                };
            };
            return FALSE;
        ...
        // Insert item
        Wld_InsertItem(G1CP_0046_SmithDoor_Item, "OCC_CELLAR_BACK_LEFT_CELL");
    ...
    mob._oCMobLockable_keyInstance = "G1CP_0046_SMITHDOOR_ITEM";
    return TRUE;
};
...
func int G1CP_0046_SmithDoorRevert() {
    ...
    // Check if the door references the expected key instance
    if (!Hlp_StrCmp(mob._oCMobLockable_keyInstance, "G1CP_0046_SmithDoor_Item")) {
        return FALSE;
    };
 ...
 */
func void G1CP_0046_SmithDoor_HookStory() {
 ...
 */
instance G1CP_0046_SmithDoor_Item(C_Item) {
    ...
    // Find the end of this instance function using "G1CP_0046_SmithDoor_ItemHlp" for help
    var int hlpSymbPtr; hlpSymbPtr = MEM_GetSymbol("G1CP_0046_SmithDoor_ItemHlp");
...
func void G1CP_0046_SmithDoor_ItemHlp() {

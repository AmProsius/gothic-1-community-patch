 ...
 */
func void G1CP_203_LogEntryGrahamMerchant_Intercept(var string topic, var string entry) {
 ...
 */
func int G1CP_203_LogEntryGrahamMerchant() {
    return G1CP_203_LogEntryGrahamMerchant_Toggle(TRUE);
};

/*
 * This function reverts the changes
 */
func int G1CP_203_LogEntryGrahamMerchantRevert() {
    // Only revert if it was applied by the G1CP
    if (!G1CP_IsFixApplied(203)) {
        return FALSE;
    };

    return G1CP_203_LogEntryGrahamMerchant_Toggle(FALSE);
};

...
func int G1CP_0121_DE_LogTopicShrikeHut() {
    ...
    var string curName; curName = G1CP_GetStringConst("CH1_ShrikesHut", 0, "");

    if (Hlp_StrCmp(curName, "Shrike's Hütte")) {
        G1CP_SetStringConst("CH1_ShrikesHut", 0, newName);
 ...
 */
func int G1CP_0121_DE_LogTopicShrikeHutRevert() {
    ...
    if (Hlp_StrCmp(curName, "Shrikes Hütte")) {
        G1CP_SetStringConst("CH1_ShrikesHut", 0, oldName); // Necessary for re-applying

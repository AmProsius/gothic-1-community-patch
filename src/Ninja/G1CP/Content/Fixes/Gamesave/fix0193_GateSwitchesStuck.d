 ...
 */
func int G1CP_0193_GateSwitchesStuck_InferState(var string targetVobName) {
    ...
    if (MEM_ReadInt(targetPtr) == zCTriggerList_vtbl) {
        ...
        return G1CP_0193_GateSwitchesStuck_InferState(act); // Recursion with new trigger target
    };
 ...
 */
func int G1CP_0193_GateSwitchesStuckRevert() {
    return TRUE;
};

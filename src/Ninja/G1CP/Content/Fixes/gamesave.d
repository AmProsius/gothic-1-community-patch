...
func int Ninja_G1CP_HookGameSaveFixes() {
    ...
    if (Ninja_G1CP_CheckBytes(oCGame__changeLevel, "6A FF 68 BE 66 7B 00"))
    && (Ninja_G1CP_CheckBytes(oCSavegameManager__ClearCurrent_ot, "8B 0D 94 96 86 00"))
    && (Ninja_G1CP_CheckBytes(CGameManager__Write_Savegame_valid, "8B 4D 20 53 56"))
    && (Ninja_G1CP_CheckBytes(oCSavegameManager__SetAndWriteSavegame, "8D 04 88 8B 08")) {

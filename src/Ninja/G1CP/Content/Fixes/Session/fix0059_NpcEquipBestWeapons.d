 ...
 */
func int G1CP_0059_NpcEquipBestWeapons() {
    ...
    || (G1CP_CheckBytes(oCNpc__Enable_equipBestWeapons, orig2) == 1) {
        ...
        HookEngineF(oCNpc__Enable_equipBestWeapons, 5, G1CP_0059_NpcEquipBestWeapons_Hook);
...
func void G1CP_0059_NpcEquipBestWeapons_Hook() {
    ...
    MEM_Call(G1CP_0192_MagicUserAutoEquip_IsMagicUser);
    if (MEM_PopIntResult()) {
        return;
    };

 ...
 */
func int G1CP_0223_CarKalomSpyQuest() {
    ...
    repeat(i, MEM_ArraySize(matches)-1); var int i;
        ...
        */
        ...
        MEMINT_OFTokPar(zPAR_TOK_CALL, MEM_GetFuncOffset(G1CP_0223_CarKalomSpyQuest_Topic1));
        MEMINT_OverrideFunc_Ptr = addrNext;
        MEMINT_OFTokPar(zPAR_TOK_CALL, MEM_GetFuncOffset(G1CP_0223_CarKalomSpyQuest_Topic2));
 ...
 */
func void G1CP_0223_CarKalomSpyQuest_Topic1(var string topic, var string entry) {
 ...
 */
func void G1CP_0223_CarKalomSpyQuest_Topic2(var string topic, var string entry) {
    G1CP_ReportFuncToSpy();

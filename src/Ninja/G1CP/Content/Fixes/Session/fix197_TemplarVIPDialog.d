 ...
 */
func int G1CP_197_TemplarVIPDialog() {
    var int applied; applied = FALSE;

    // Specifics
    var int funcId; funcId = MEM_GetSymbolIndex("Info_Tpl_8_DasLager_Info");
    const string ou = "Info_Tpl_8_DasLager_08_02";
    ...
    repeat(i, MEM_ArraySize(matches)); var int i;
        ...
        // Confirm: AI_Output(other, self, "Info_Tpl_8_DasLager_08_02");
        if (arg1 == other) && (arg2 == self)

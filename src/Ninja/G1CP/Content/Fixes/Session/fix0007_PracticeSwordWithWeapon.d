 ...
 */
func int G1CP_0007_PracticeSwordWithWeapon() {
    if (G1CP_IsFunc("ZS_PracticeSword_Loop", "|none")) { // Should be "int|none" but is void in the original
        HookDaedalusFuncS("ZS_PracticeSword_Loop", "G1CP_0007_PracticeSwordWithWeapon_Hook");
        return TRUE;
    } else {
        return FALSE;
    };
 ...
 */
func void G1CP_0007_PracticeSwordWithWeapon_Hook() {

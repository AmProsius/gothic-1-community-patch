 ...
 */
func int G1CP_0115_KillSittingDuck() {
    ...
    if (MEM_ArraySize(matches) == 1) {
        ...
        if (valid) {
            ...
            MEMINT_OFTokPar(zPAR_TOK_CALL, MEM_GetFuncOffset(G1CP_0115_KillSittingDuck_Intercept));
            applied = TRUE;
        };
    };
 ...
 */
func int G1CP_0115_KillSittingDuck_Intercept(var C_Npc self, var float ms) {

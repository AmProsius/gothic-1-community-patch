 ...
 */
func int G1CP_0032_GornAttackFreeMine() {
    ...
    var int state2Id; state2Id = MEM_GetFuncId(G1CP_0032_GornAttackFreeMine_AttackRelay);
    ...
    repeat(i, MEM_ArraySize(matches)); var int i;
        ...
        && (MEM_ReadInt(pos+16)  == sstateId) {
            ...
            // Overwrite "ZS_ProclaimAndPunish" with "G1CP_0032_GornAttackFreeMine_AttackRelay"
    ...
    if (applied) {
        HookDaedalusFuncI(memFncId, MEM_GetFuncId(G1CP_0032_GornAttackFreeMine_NoTrauma));
    };
 ...
 */
func void G1CP_0032_GornAttackFreeMine_AttackRelay() {
 ...
 */
func void G1CP_0032_GornAttackFreeMine_NoTrauma(var int newsid, var int source, var C_Npc witness,

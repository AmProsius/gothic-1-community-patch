 ...
 */
func int G1CP_0181_SwineyGiveArmor() {
    if (G1CP_IsFunc("Info_Swiney_Schuerfer_Ja", "void|none"))
    && (G1CP_IsFunc("Info_Swiney_Schuerfer_Nein", "void|none")) {
        HookDaedalusFuncS("Info_Swiney_Schuerfer_Ja", "G1CP_0181_SwineyGiveArmor_Hook1");
        HookDaedalusFuncS("Info_Swiney_Schuerfer_Nein", "G1CP_0181_SwineyGiveArmor_Hook2");
        return TRUE;
    } else {
        return FALSE;
    };
 ...
 */
func int G1CP_0181_SwineyGiveArmor_Hook1() {
 ...
 */
func int G1CP_0181_SwineyGiveArmor_Hook2() {
    G1CP_ReportFuncToSpy();

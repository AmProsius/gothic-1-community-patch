...
func int G1CP_NpcGetAIVar(var C_Npc slf, var string AIVarName, var int dflt) {
    ...
    if (!G1CP_IsIntVar(AIVarName, 0)) {
        return dflt;
    };

    // Read AI-variable
    return MEM_ReadStatArr(slf.aivar, G1CP_GetIntVar(AIVarName, 0, 0));
};
...
func void G1CP_NpcSetAIVar(var C_Npc slf, var string AIVarName, var int value) {
    ...
    // Write AI-variable
    MEM_WriteStatArr(slf.aivar, G1CP_GetIntVar(AIVarName, 0, 0), value);
};
